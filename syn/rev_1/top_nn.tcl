...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|top_nn"
...
set_global_assignment -section_id top_nn -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "top_nn.scf"
